...
declare module '*/ProductEntityFragment.graphql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
  export const ProductEntity: DocumentNode;
...
declare module '*/ProductVariantValues.graphql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
...
declare module '*/VariantFragment.graphql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
...
declare module '*/VariantValueFragment.graphql' {
  import { DocumentNode } from 'graphql';
  const defaultDocument: DocumentNode;
